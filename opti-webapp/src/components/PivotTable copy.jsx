                    ...
                    return (
                      ...
                      >
                        ...
                        {isFirstRowCanal && (
                          <>
                            {productCollapsed ? (
                              <td rowSpan={METRICS.length} className="col-canal pivot-row-header">
                                Total canales
                              </td>
                            ) : (
                              <td
                              ...
                              >
                                <button
                                  ...
                                  onClick={() => toggleChannel(pg.producto, cg.canal)}
                                >
                                  {channelCollapsed ? "+" : "–"}
                                </button>{" "}
                                {cg.canal}
                        ...
                        {isFirstRowUbic && (
                          <>
                            {productCollapsed || channelCollapsed ? (
                              <td rowSpan={METRICS.length} className="col-ubicacion pivot-row-header">
                                Total ubicaciones
                              </td>
                            ) : (
                              <td rowSpan={ug.rowSpanUbic} className="col-ubicacion pivot-row-header">
                                {ug.ubicacion}
                              </td>
                            )}
                          </>
                        ...
                        {allDates.map((d) => {
                          ...
                          if (isProductAgg) {
                            if (metric.key === "asertividad") {
                              ...
                              rawValue = productTotals[pg.producto]?.[metric.key]?.[dateKey] ?? null;
                            }
