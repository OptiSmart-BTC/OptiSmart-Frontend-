        ...
        {user?.userType === "A" && (
          <>
            <NavbarItem
              ...
              className={
                isActiveParent("/politicas-de-inventario") ? "activeParent" : ""
              }
            >
            ...
            <NavbarItem
              label="Plan de reposición"
              className={
                isActiveParent("/plan-de-reposicion") ? "activeParent" : ""
              }
            >
              <ul className="navbar-dropdown">
                <DropdownItem
                  label="Archivos"
                  path="/plan-de-reposicion/archivos"
                  className={
                    isActive("/plan-de-reposicion/archivos") ? "active" : ""
                  }
                />
              </ul>
              <ul className="navbar-dropdown">
                <DropdownItem
                  label="Resultados"
                  path="/plan-de-reposicion/resultados"
                  className={
                    isActive("/plan-de-reposicion/resultados") ? "active" : ""
                  }
                />
              </ul>
              <DropdownItem
